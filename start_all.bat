...
start "Main.java adapter" cmd /k "mvn -f pom.xml compile exec:java -Dexec.mainClass=at.fhhagenberg.sqelevator.adapter.Main"

REM Use Maven to compile and run the first Main.java in a new CMD window
start "Main.java algorithm" cmd /k "mvn -f pom.xml compile exec:java -Dexec.mainClass=at.fhhagenberg.sqelevator.algorithm.Main"
